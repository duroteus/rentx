...
let CreateCategoryUseCase = class CreateCategoryUseCase {
    ...
    execute({ name, description }) {
        return __awaiter(this, void 0, void 0, function* () {
            const categoryAlreadyExist = yield this.categoriesRepository.findByName(name);
            if (categoryAlreadyExist) {
                throw new AppError_1.AppError("Category already exists!");
            }
            yield this.categoriesRepository.create({ name, description });
        });
    }
};
