...
class ListAvailableCarsController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const listAvailableCarsUseCase = tsyringe_1.container.resolve(ListAvailableCarUseCase_1.ListAvailableCarsUseCase);
            const availableCars = yield listAvailableCarsUseCase.execute({
                name: name,
                brand: brand,
