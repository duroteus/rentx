...
let ListSpecificationUseCase = class ListSpecificationUseCase {
    constructor(specificationsRepository) {
        this.specificationsRepository = specificationsRepository;
    }
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            const categories = yield this.specificationsRepository.list();
            return categories;
        });
    }
};
ListSpecificationUseCase = __decorate([
